...
export default function WithSubnavigation() {
  ...
  return (
    <Box>
        ...
        >
          ...
          {!isAdmin && (
            <Flex display={{ base: "none", md: "block" }}>
              ...
              {/* Some button that comes on top left if screen is small, probably */}
              <Modal
                onClose={onClose}
                isOpen={isOpen}
                isCentered
      ...
      {/* Mobile navigation bar, but it's kinda covered by the create market button
          but we're prob gonna make a separate admin page */}
